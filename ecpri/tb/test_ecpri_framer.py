...
def test_ecpri_framer_runner():
    ...
    verilog_sources = [
        prj_path / "rtl/ecpri_axis_reg.v",
        prj_path / "rtl/ecpri_framer_common.v",
        prj_path / "rtl/ecpri_framer_eth_reg.v",
        prj_path / "rtl/ecpri_framer_eth.v",
        prj_path / "rtl/ecpri_framer_eth.v",
    ...
    test_args = [
        # f"-gBIT_REVERSED_INPUT={BIT_REVERSED_INPUT}",
    ]
