...
module ecpri_odm (
  ...
  localparam reg [7:0] ODM_ACTION_TYPE_REQUEST = 8'h00;
  localparam reg [7:0] ODM_ACTION_TYPE_REQUEST_WITH_FOLLOW_UP = 8'h01;
  localparam reg [7:0] ODM_ACTION_TYPE_RESPONSE = 8'h02;
  localparam reg [7:0] ODM_ACTION_TYPE_REMOTE_REQUEST = 8'h03;
  localparam reg [7:0] ODM_ACTION_TYPE_REMOTE_REQUEST_WITH_FOLLOW_UP = 8'h04;
  localparam reg [7:0] ODM_ACTION_TYPE_FOLLOW_UP = 8'h05;

  function [79:0] ts_diff(input reg [79:0] ts1, input reg [79:0] ts2);
    reg [31:0] ns;
    reg [47:0] sec;
    begin
  ...
  function [79:0] ts_wrap(input reg [79:0] ts1);
    reg [31:0] ns;
    reg [47:0] sec;
    begin
      ns  = ts1[31:0];
  ...
  reg  [79:0] ts_ingress;
  reg  [ 7:0] ts_ingress_measurementid;
  reg  [79:0] ts_diff_ingress;
  reg  [79:0] ts_diff_ingress_wrap;
  reg         ts_diff_ingress_valid;
  reg         ts_diff_ingress_wrap_valid;

  reg  [79:0] ts_egress;
  reg  [ 7:0] ts_egress_measurementid;
  reg  [79:0] ts_diff_egress;
  reg  [79:0] ts_diff_egress_wrap;
  reg         ts_diff_egress_valid;
  reg         ts_diff_egress_wrap_valid;
