...
LUT_FILE = prj_path / "hdl" / "dec_8b10b.mif"
...
def test_dec_8b10b_runner(use_lut, tmp_path):
    ...
    runner.build(
        ...
        sources=[
            prj_path / "hdl" / "dec_8b10b_logic.sv",
            prj_path / "hdl" / "dec_8b10b_lut.sv",
            prj_path / "hdl" / "dec_8b10b.sv",
            prj_path / "hdl" / "dec_8b10b_synth.sv",
        ],
        parameters={
            "C_USE_LUT": use_lut,
