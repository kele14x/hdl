...
module dec_8b10b_logic (
  ...
  assign charisk = {c,d,e,i} == 4'b0000 || {c,d,e,i} == 4'b1111 ||
  ...
  assign notintable = b6_notintable || b4_notintable || b6b4_disp_mismatch ||
  ...
  wire dispout, disperr;

  assign dispout = b4_disp == neg ? 1'b0 :
                     b4_disp == pos ? 1'b1 :
                     b4_disp == specneg ? 1'b0 :
                     b4_disp == specpos ? 1'b1 :
                     disp_temp;

  assign disperr = b6b4_disp_mismatch || (b6_disp == pos && dispin) ||
  ...
  assign dec_result = {disperr, dispout, notintable, charisk, b3, b5};
