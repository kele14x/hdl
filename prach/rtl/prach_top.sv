...
module prach_top #(
    ...
    input  wire  [22:0] ctrl_ta3_offset        [NUM_CC],
    //
    input  wire  [ 3:0] ctrl_static_c          [NUM_CC],
    //
    input  wire  [ 3:0] ctrl_subframe_inc      [NUM_CC],
    input  wire  [ 3:0] ctrl_subframe_id       [NUM_CC],
    input  wire  [ 5:0] ctrl_slot_id           [NUM_CC],
    input  wire  [ 5:0] ctrl_symbol_id         [NUM_CC],
    //
    input  wire  [15:0] ctrl_time_offset       [NUM_CC],
    input  wire  [15:0] ctrl_cp_length         [NUM_CC],
    //
    input  wire  [ 3:0] ctrl_num_symbol        [NUM_CC],
    input  wire  [23:0] ctrl_freq_offset       [NUM_CC],
    //
