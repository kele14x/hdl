...
set_property PACKAGE_PIN Y5  [get_ports {GX_RTD_SPI_SDI[0]}]
set_property PACKAGE_PIN J17 [get_ports {GX_RTD_SPI_SDI[1]}]
set_property PACKAGE_PIN W12 [get_ports {GX_RTD_SPI_SDI[2]}]
set_property PACKAGE_PIN N17 [get_ports {GX_RTD_SPI_SDI[3]}]
set_property PACKAGE_PIN Y21 [get_ports {GX_RTD_SPI_SDI[4]}]
set_property PACKAGE_PIN V14 [get_ports {GX_RTD_SPI_SDI[5]}]

set_property PACKAGE_PIN W7   [get_ports {GX_RTD_SPI_SDO[0]}]
set_property PACKAGE_PIN P18  [get_ports {GX_RTD_SPI_SDO[1]}]
set_property PACKAGE_PIN R7   [get_ports {GX_RTD_SPI_SDO[2]}]
set_property PACKAGE_PIN T16  [get_ports {GX_RTD_SPI_SDO[3]}]
set_property PACKAGE_PIN AB14 [get_ports {GX_RTD_SPI_SDO[4]}]
set_property PACKAGE_PIN U14  [get_ports {GX_RTD_SPI_SDO[5]}]
...
set_property PACKAGE_PIN AB6  [get_ports {GX_TC_SPI_SDI[0]}]
set_property PACKAGE_PIN L19  [get_ports {GX_TC_SPI_SDI[1]}]
set_property PACKAGE_PIN U12  [get_ports {GX_TC_SPI_SDI[2]}]
set_property PACKAGE_PIN J22  [get_ports {GX_TC_SPI_SDI[3]}]
set_property PACKAGE_PIN AA22 [get_ports {GX_TC_SPI_SDI[4]}]
set_property PACKAGE_PIN U16  [get_ports {GX_TC_SPI_SDI[5]}]

set_property PACKAGE_PIN AB5  [get_ports {GX_TC_SPI_SDO[0]}]
set_property PACKAGE_PIN L17  [get_ports {GX_TC_SPI_SDO[1]}]
set_property PACKAGE_PIN V12  [get_ports {GX_TC_SPI_SDO[2]}]
set_property PACKAGE_PIN K21  [get_ports {GX_TC_SPI_SDO[3]}]
