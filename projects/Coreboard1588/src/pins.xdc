...
set_property PACKAGE_PIN M6  [get_ports FPGA_MCU_GPIO5]
set_property PACKAGE_PIN B16 [get_ports FPGA_RAM_ADDR0]
...
set_property PACKAGE_PIN F18 [get_ports FPGA_SPI1_CS]
set_property PACKAGE_PIN G18 [get_ports FPGA_SPI1_CLK]
set_property PACKAGE_PIN E18 [get_ports FPGA_SPI1_MOSI]
set_property PACKAGE_PIN J18 [get_ports FPGA_SPI1_MISO]

set_property PACKAGE_PIN B18 [get_ports AD1_RST]

set_property PACKAGE_PIN A13 [get_ports {CH_SEL_A[0]}]
set_property PACKAGE_PIN A14 [get_ports {CH_SEL_A[1]}]
set_property PACKAGE_PIN A16 [get_ports {CH_SEL_A[2]}]

set_property PACKAGE_PIN A18 [get_ports EN_TCH_A]
set_property PACKAGE_PIN D18 [get_ports EN_PCH_A]
