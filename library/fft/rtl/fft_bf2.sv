...
module fft_bf2 #(
    ...
    input var                          sel,
    //
    input var  signed [DATA_WIDTH-1:0] delayed_i_in,
    input var  signed [DATA_WIDTH-1:0] delayed_q_in,
    //
    input var  signed [DATA_WIDTH-1:0] data_i_in,
    input var  signed [DATA_WIDTH-1:0] data_q_in,
    //
    output var signed [DATA_WIDTH-1:0] delayed_i_out,
    output var signed [DATA_WIDTH-1:0] delayed_q_out,
    //
