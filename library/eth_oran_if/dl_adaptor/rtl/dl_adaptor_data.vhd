...
begin
  ...
  concat8 : entity work.sysgen_concat_8587dcc071 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux1 : entity work.sysgen_mux_56d7e81518 
  port map (
    clr => '0',
  ...
  mux2 : entity work.sysgen_mux_7ea13f1263 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux4 : entity work.sysgen_mux_7ea13f1263 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  synbol_cnt1 : entity work.sysgen_counter_6f7d30d597 
  port map (
    clr => '0',
    rst => sof_i_net,
    en => sop_i_net,
