...
architecture structural of dl_adaptor_ctrl_counter_0 is 
  ...
  signal constant15_op_net : std_logic_vector( 14-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  constant15 : entity work.sysgen_constant_9a23ae2db2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational11 : entity work.sysgen_relational_7ba4a77ee9 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
architecture structural of dl_adaptor_ctrl_struct is 
  ...
  signal counter12_op_net : std_logic_vector( 15-1 downto 0 );
  signal concat5_y_net : std_logic_vector( 15-1 downto 0 );
  signal constant3_op_net : std_logic_vector( 13-1 downto 0 );
...
begin
  ...
  sof0_i_net <= sof0_i;
  sof_ahead_7_o <= register22_q_net;
  sof_o <= delay2_q_net;
  sop_ahead_7_o <= logical1_y_net;
  sop_o <= delay1_q_net;
  ...
  concat5 : entity work.sysgen_concat_7e5e00d6c2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    in0 => mux36_y_net,
    in1 => constant3_op_net,
    y => concat5_y_net
  );
  ...
  constant3 : entity work.sysgen_constant_8578764b06 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational3 : entity work.sysgen_relational_d1d9ecab43 
  port map (
    clr => '0',
