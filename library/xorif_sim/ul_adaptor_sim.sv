...
module dl_adaptor_sim #(
    ...
    output var [63:0] m_fram_data_tdata    [NUM_DL_LAYER],
    output var [ 7:0] m_fram_data_tkeep    [NUM_DL_LAYER],
    output var        m_fram_data_tvalid   [NUM_DL_LAYER],
    output var        m_fram_data_tlast    [NUM_DL_LAYER],
    input var         m_fram_data_tready   [NUM_DL_LAYER],
    //
    input var  [30:0] m_fram_data_req      [NUM_DL_LAYER],
    // Interface with DFE
    //===================
    ...
    output var        ul_sof               [      NUM_CC],
    output var        ul_sos               [      NUM_CC],
    output var [15:0] ul_data_i            [      NUM_CC][NUM_DL_LAYER],
    output var [15:0] ul_data_q            [      NUM_CC][NUM_DL_LAYER],
    output var        ul_valid             [      NUM_CC],
    // Control Interface
    //==================
