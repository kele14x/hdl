# Vivado 2026.1 out-of-context synthesis for the PUXCH top.
#
# Usage:
#   vivado.bat -mode batch -source puxch/synth/puxch_top_ooc.tcl -nojournal \
#              -log vivado_puxch_top.log
#
# tclargs: <half_block> <half_fft> <repo_root>
#   half_block=0/1 -> buffer IQ depth full/half
#   half_fft=0/1   -> FFT 4k/2k
#   repo_root      -> alternate checkout (e.g. git worktree of an old commit)
#                     for baseline-vs-final resource comparisons
...
set build_dir [file normalize [file join $repo_root sim_build vivado_ooc_puxch_top_20260824]]
puts "INFO: puxch OOC params: HALF_BLOCK=$half_block HALF_FFT=$half_fft"
puts "INFO: puxch OOC repo_root: $repo_root"
puts "INFO: puxch OOC build_dir: $build_dir"
...
# OOC clock constraints: clk 491.52 MHz, clk_eth_xran 400 MHz, ctrl_clk 100 MHz
read_xdc [file join $script_dir puxch_top_ooc.xdc]
