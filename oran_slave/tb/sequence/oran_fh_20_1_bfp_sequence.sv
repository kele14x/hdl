`ifndef __ORAN_FH_20_1_BFP_SEQUENCE__
`define __ORAN_FH_20_1_BFP_SEQUENCE__
...
// 20MHz 1 Ant
//
class oran_fh_20_1_bfp_sequence extends uvm_sequence #(oran_fh_transaction);

  // Macro

  `uvm_object_utils(oran_fh_20_1_bfp_sequence)

  // Constructor

  function new(input string name = "unnamed_oran_fh_20_1_bfp_sequence");
    super.new(.name(name));
  endfunction : new
...
endclass : oran_fh_20_1_bfp_sequence
