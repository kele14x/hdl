...
module lowphy1 (
    ...
    //
    input var  [ 11:0] s1_axi_awaddr,
    input var  [  2:0] s1_axi_awprot,
    input var          s1_axi_awvalid,
    output var         s1_axi_awready,
    //
    input var  [ 31:0] s1_axi_wdata,
    input var  [  3:0] s1_axi_wstrb,
    input var          s1_axi_wvalid,
    output var         s1_axi_wready,
    //
    output var [  1:0] s1_axi_bresp,
    output var         s1_axi_bvalid,
    input var          s1_axi_bready,
    //
    input var  [ 11:0] s1_axi_araddr,
    input var  [  2:0] s1_axi_arprot,
    input var          s1_axi_arvalid,
    output var         s1_axi_arready,
    //
    output var [ 31:0] s1_axi_rdata,
    output var [  1:0] s1_axi_rresp,
    output var         s1_axi_rvalid,
    input var          s1_axi_rready,
    //
    input var  [ 11:0] s2_axi_awaddr,
    input var  [  2:0] s2_axi_awprot,
    input var          s2_axi_awvalid,
    output var         s2_axi_awready,
    //
    input var  [ 31:0] s2_axi_wdata,
    input var  [  3:0] s2_axi_wstrb,
    input var          s2_axi_wvalid,
    output var         s2_axi_wready,
    //
    output var [  1:0] s2_axi_bresp,
    output var         s2_axi_bvalid,
    input var          s2_axi_bready,
    //
    input var  [ 11:0] s2_axi_araddr,
    input var  [  2:0] s2_axi_arprot,
    input var          s2_axi_arvalid,
    output var         s2_axi_arready,
    //
    output var [ 31:0] s2_axi_rdata,
    output var [  1:0] s2_axi_rresp,
    output var         s2_axi_rvalid,
    input var          s2_axi_rready,
    // ORAN-IF Interfaces
    //-------------------
    // Early BID ports
    ...
    //
    input var  [ 11:0] s3_ul_sym_num,
    input var  [ 11:0] s3_ul_cta_sym_num,
    input var          s3_ul_update,
    input var          s3_ul_slot_update,
    input var  [ 11:0] s3_dl_sym_num,
    input var  [ 11:0] s3_dl_cta_sym_num,
    input var          s3_dl_update,
    input var          s3_dl_slot_update,
    input var          s3_ul_toggle,
    input var          s3_dl_toggle,
    // input  wire         s3_ul_symbol_inc,
    // input  wire         s3_dl_symbol_inc,
    input var          s3_cc_enable,
    input var          s3_cc_reload,
    //
    input var  [ 11:0] s4_ul_sym_num,
    input var  [ 11:0] s4_ul_cta_sym_num,
    input var          s4_ul_update,
    input var          s4_ul_slot_update,
    input var  [ 11:0] s4_dl_sym_num,
    input var  [ 11:0] s4_dl_cta_sym_num,
    input var          s4_dl_update,
    input var          s4_dl_slot_update,
    input var          s4_ul_toggle,
    input var          s4_dl_toggle,
    ...
    input var          s5_ul_slot_update,
    input var  [ 11:0] s5_dl_sym_num,
    input var  [ 11:0] s5_dl_cta_sym_num,
    input var          s5_dl_update,
    input var          s5_dl_slot_update,
    input var          s5_ul_toggle,
    input var          s5_dl_toggle,
    ...
    input var          s6_ul_update,
    input var          s6_ul_slot_update,
    input var  [ 11:0] s6_dl_sym_num,
    input var  [ 11:0] s6_dl_cta_sym_num,
    input var          s6_dl_update,
    input var          s6_dl_slot_update,
    input var          s6_ul_toggle,
    input var          s6_dl_toggle,
    // input  wire         s6_ul_symbol_inc,
    // input  wire         s6_dl_symbol_inc,
    input var          s6_cc_enable,
    input var          s6_cc_reload,
    //
    input var  [ 11:0] s7_ul_sym_num,
    input var  [ 11:0] s7_ul_cta_sym_num,
    input var          s7_ul_update,
    input var          s7_ul_slot_update,
    input var  [ 11:0] s7_dl_sym_num,
    input var  [ 11:0] s7_dl_cta_sym_num,
    input var          s7_dl_update,
    input var          s7_dl_slot_update,
    input var          s7_ul_toggle,
    input var          s7_dl_toggle,
    ...
    input var          s8_ul_slot_update,
    input var  [ 11:0] s8_dl_sym_num,
    input var  [ 11:0] s8_dl_cta_sym_num,
    input var          s8_dl_update,
    input var          s8_dl_slot_update,
    input var          s8_ul_toggle,
    input var          s8_dl_toggle,
    ...
    //
    output var [ 63:0] m004_fram_data_tdata,
    output var [  7:0] m004_fram_data_tkeep,
    output var         m004_fram_data_tvalid,
    output var         m004_fram_data_tlast,
    input var          m004_fram_data_tready,
    input var  [ 32:0] m004_fram_data_req,
    //
    input var  [107:0] s004_fram_bid_debug,
    input var          s004_fram_bid_valid,
    input var          s004_fram_bid_tlast,
    output var         s004_fram_bid_ready,
    input var          s004_fram_bid_off,
    input var  [ 14:0] s004_fram_bid_beamid15,
    input var  [ 11:0] s004_fram_bid_remask,
    input var          s004_fram_bid_rb,
    input var  [  9:0] s004_fram_bid_start_prbc,
    input var  [  7:0] s004_fram_bid_num_prbc,
    input var  [  3:0] s004_fram_bid_num_symbol,
    input var  [  7:0] s004_fram_bid_cc_id,
    input var  [ 23:0] s004_fram_bid_frequency_offset,
    input var  [ 15:0] s004_fram_bid_time_offset,
    input var  [  7:0] s004_fram_bid_frame_structure,
    input var  [ 15:0] s004_fram_bid_cp_length,
    //
    output var [ 63:0] m005_fram_data_tdata,
    output var [  7:0] m005_fram_data_tkeep,
    output var         m005_fram_data_tvalid,
    output var         m005_fram_data_tlast,
    input var          m005_fram_data_tready,
    input var  [ 32:0] m005_fram_data_req,
    //
    input var  [107:0] s005_fram_bid_debug,
    input var          s005_fram_bid_valid,
    input var          s005_fram_bid_tlast,
    output var         s005_fram_bid_ready,
    input var          s005_fram_bid_off,
    input var  [ 14:0] s005_fram_bid_beamid15,
    input var  [ 11:0] s005_fram_bid_remask,
    input var          s005_fram_bid_rb,
    input var  [  9:0] s005_fram_bid_start_prbc,
    input var  [  7:0] s005_fram_bid_num_prbc,
    input var  [  3:0] s005_fram_bid_num_symbol,
    input var  [  7:0] s005_fram_bid_cc_id,
    input var  [ 23:0] s005_fram_bid_frequency_offset,
    input var  [ 15:0] s005_fram_bid_time_offset,
    input var  [  7:0] s005_fram_bid_frame_structure,
    input var  [ 15:0] s005_fram_bid_cp_length,
    //
    output var [ 63:0] m006_fram_data_tdata,
    output var [  7:0] m006_fram_data_tkeep,
    output var         m006_fram_data_tvalid,
    output var         m006_fram_data_tlast,
    input var          m006_fram_data_tready,
    input var  [ 32:0] m006_fram_data_req,
    //
    input var  [107:0] s006_fram_bid_debug,
    input var          s006_fram_bid_valid,
    input var          s006_fram_bid_tlast,
    output var         s006_fram_bid_ready,
    input var          s006_fram_bid_off,
    input var  [ 14:0] s006_fram_bid_beamid15,
    input var  [ 11:0] s006_fram_bid_remask,
    input var          s006_fram_bid_rb,
    input var  [  9:0] s006_fram_bid_start_prbc,
    input var  [  7:0] s006_fram_bid_num_prbc,
    input var  [  3:0] s006_fram_bid_num_symbol,
    input var  [  7:0] s006_fram_bid_cc_id,
    input var  [ 23:0] s006_fram_bid_frequency_offset,
    input var  [ 15:0] s006_fram_bid_time_offset,
    input var  [  7:0] s006_fram_bid_frame_structure,
    input var  [ 15:0] s006_fram_bid_cp_length,
    //
    output var [ 63:0] m007_fram_data_tdata,
    output var [  7:0] m007_fram_data_tkeep,
    output var         m007_fram_data_tvalid,
    output var         m007_fram_data_tlast,
    input var          m007_fram_data_tready,
    input var  [ 32:0] m007_fram_data_req,
    //
    input var  [107:0] s007_fram_bid_debug,
    input var          s007_fram_bid_valid,
    input var          s007_fram_bid_tlast,
    output var         s007_fram_bid_ready,
    input var          s007_fram_bid_off,
    input var  [ 14:0] s007_fram_bid_beamid15,
    input var  [ 11:0] s007_fram_bid_remask,
    input var          s007_fram_bid_rb,
    input var  [  9:0] s007_fram_bid_start_prbc,
    input var  [  7:0] s007_fram_bid_num_prbc,
    input var  [  3:0] s007_fram_bid_num_symbol,
    input var  [  7:0] s007_fram_bid_cc_id,
    input var  [ 23:0] s007_fram_bid_frequency_offset,
    input var  [ 15:0] s007_fram_bid_time_offset,
    input var  [  7:0] s007_fram_bid_frame_structure,
    input var  [ 15:0] s007_fram_bid_cp_length,
    //
    ...
    //
    input var  [ 63:0] s004_defm_data_tdata,
    input var  [  7:0] s004_defm_data_tkeep,
    input var          s004_defm_data_tvalid,
    input var          s004_defm_data_tlast,
    output var         s004_defm_data_tready,
    input var  [ 90:0] s004_defm_data_tuser,
    input var  [  4:0] s004_defm_data_tdest,
    //
    input var          s004_defm_bid_valid,
    input var          s004_defm_bid_tlast,
    output var         s004_defm_bid_ready,
    input var          s004_defm_bid_off,
    input var  [ 14:0] s004_defm_bid_beamid15,
    input var  [ 11:0] s004_defm_bid_remask,
    input var          s004_defm_bid_rb,
    input var  [  9:0] s004_defm_bid_start_prbc,
    input var  [  7:0] s004_defm_bid_num_prbc,
    input var  [  3:0] s004_defm_bid_num_symbol,
    input var  [  7:0] s004_defm_bid_cc_id,
    input var  [ 23:0] s004_defm_bid_frequency_offset,
    input var  [ 15:0] s004_defm_bid_time_offset,
    input var  [  7:0] s004_defm_bid_frame_structure,
    input var  [ 15:0] s004_defm_bid_cp_length,
    //
    input var  [ 63:0] s005_defm_data_tdata,
    input var  [  7:0] s005_defm_data_tkeep,
    input var          s005_defm_data_tvalid,
    input var          s005_defm_data_tlast,
    output var         s005_defm_data_tready,
    input var  [ 90:0] s005_defm_data_tuser,
    input var  [  4:0] s005_defm_data_tdest,
    //
    input var          s005_defm_bid_valid,
    input var          s005_defm_bid_tlast,
    output var         s005_defm_bid_ready,
    input var          s005_defm_bid_off,
    input var  [ 14:0] s005_defm_bid_beamid15,
    input var  [ 11:0] s005_defm_bid_remask,
    input var          s005_defm_bid_rb,
    input var  [  9:0] s005_defm_bid_start_prbc,
    input var  [  7:0] s005_defm_bid_num_prbc,
    input var  [  3:0] s005_defm_bid_num_symbol,
    input var  [  7:0] s005_defm_bid_cc_id,
    input var  [ 23:0] s005_defm_bid_frequency_offset,
    input var  [ 15:0] s005_defm_bid_time_offset,
    input var  [  7:0] s005_defm_bid_frame_structure,
    input var  [ 15:0] s005_defm_bid_cp_length,
    //
    input var  [ 63:0] s006_defm_data_tdata,
    input var  [  7:0] s006_defm_data_tkeep,
    input var          s006_defm_data_tvalid,
    input var          s006_defm_data_tlast,
    output var         s006_defm_data_tready,
    input var  [ 90:0] s006_defm_data_tuser,
    input var  [  4:0] s006_defm_data_tdest,
    //
    input var          s006_defm_bid_valid,
    input var          s006_defm_bid_tlast,
    output var         s006_defm_bid_ready,
    input var          s006_defm_bid_off,
    input var  [ 14:0] s006_defm_bid_beamid15,
    input var  [ 11:0] s006_defm_bid_remask,
    input var          s006_defm_bid_rb,
    input var  [  9:0] s006_defm_bid_start_prbc,
    input var  [  7:0] s006_defm_bid_num_prbc,
    input var  [  3:0] s006_defm_bid_num_symbol,
    input var  [  7:0] s006_defm_bid_cc_id,
    input var  [ 23:0] s006_defm_bid_frequency_offset,
    input var  [ 15:0] s006_defm_bid_time_offset,
    input var  [  7:0] s006_defm_bid_frame_structure,
    input var  [ 15:0] s006_defm_bid_cp_length,
    //
    input var  [ 63:0] s007_defm_data_tdata,
    input var  [  7:0] s007_defm_data_tkeep,
    input var          s007_defm_data_tvalid,
    input var          s007_defm_data_tlast,
    output var         s007_defm_data_tready,
    input var  [ 90:0] s007_defm_data_tuser,
    input var  [  4:0] s007_defm_data_tdest,
    //
    input var          s007_defm_bid_valid,
    input var          s007_defm_bid_tlast,
    output var         s007_defm_bid_ready,
    input var          s007_defm_bid_off,
    input var  [ 14:0] s007_defm_bid_beamid15,
    input var  [ 11:0] s007_defm_bid_remask,
    input var          s007_defm_bid_rb,
    input var  [  9:0] s007_defm_bid_start_prbc,
    input var  [  7:0] s007_defm_bid_num_prbc,
    input var  [  3:0] s007_defm_bid_num_symbol,
    input var  [  7:0] s007_defm_bid_cc_id,
    input var  [ 23:0] s007_defm_bid_frequency_offset,
    input var  [ 15:0] s007_defm_bid_time_offset,
    input var  [  7:0] s007_defm_bid_frame_structure,
    input var  [ 15:0] s007_defm_bid_cp_length,
    // ORAN prase ports
    ...
    output var         fram_radio_start_10ms_cc3,
    output var         defm_radio_start_10ms_cc3,
    output var         fram_radio_start_10ms_cc4,
    output var         defm_radio_start_10ms_cc4,
    output var         fram_radio_start_10ms_cc5,
    output var         defm_radio_start_10ms_cc5,
    output var         fram_radio_start_10ms_cc6,
    output var         defm_radio_start_10ms_cc6,
    output var         fram_radio_start_10ms_cc7,
    output var         defm_radio_start_10ms_cc7,
    output var         fram_radio_start_10ms_cc8,
    output var         defm_radio_start_10ms_cc8,
    // SSB ports
    ...
    input var          rst,
    //
    output var [767:0] m_dl_axis_tdata,
