% File: check_fft_output.m
% Brief: Check FFT output
%%
clc;
clearvars;
close all;

copyfile('../prj/project_1.sim/sim_1/behav/xsim/lowphy_fft_output.txt', ...
    '.');

%%
ref_raw = readmatrix("lowphy_ifft_input.txt", "OutputType", "char");
...
%
out_raw = readmatrix("lowphy_fft_output.txt", "OutputType", "char");
